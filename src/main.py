...
def copy_dir_to_target_dir(src_dir, dst_dir):
    for item in os.listdir(src_dir):
        ...
        copy_dir_to_target_dir(src_path, target_dir)

def remove_directory_contents(target_dir):
    shutil.rmtree(target_dir)
    os.makedirs(target_dir)

def create_html_from_template(from_path, template_path, dest_path):
...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path):
    for item in os.listdir(dir_path_content):
        ...
        if os.path.isdir(src_path):
            ...
            generate_pages_recursive(src_path, template_path, target_dir)
            continue
        ...
        create_html_from_template(src_path, template_path, target_dest_dir)
...
def initialize_static_site():
    ...
    copy_dir_to_target_dir(static_path, public_path)

    # from_src = os.path.join(project_root, "content/index.md")
    # template_src = os.path.join(project_root, "template.html")
    # dest_src = os.path.join(project_root, "public/index.html")
    # create_html_from_template(from_src, template_src, dest_src)

    content_path = os.path.join(project_root, "content")
    template_path = os.path.join(project_root, "template.html")
    dest_dir_path = os.path.join(project_root, "public")
